...
"}"))
        ...
        self.substract = QtWidgets.QPushButton(Dialog)
        ...
        self.sq_root = QtWidgets.QPushButton(Dialog)
        ...
        self.power = QtWidgets.QPushButton(Dialog)
